...
export default function ReviewSubmit({ formData, categories, subcategories, eventTypes }: ReviewSubmitProps) {
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-gray-900">{formData.address+', '+formData.suburb+', '+formData.State+', '+formData.Country || "Not provided"}</p>
            </div>
            <div>
